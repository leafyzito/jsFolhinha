...
export class CreateRegex {
    ...
    check(mainInput, arrayInput, channelID) {
        let _a;
        if (!mainInput && !arrayInput) return;
        const fullInput =
            mainInput +
            ((_a =
                arrayInput === null || arrayInput === void 0 ? void 0 : arrayInput.toString()) !==
                null && _a !== void 0
                ? _a
                : '');
        ...
        const tests = [
            {
                name: 'racism',
                check: () => this.racism.test(testString),
                match: () => testString.match(this.racism)?.[0],
            },
            {
                name: 'racism2',
                check: () => this.racism2.test(testString),
                match: () => testString.match(this.racism2)?.[0],
            },
            {
                name: 'racism3',
                check: () => this.racism3.test(testString),
                match: () => testString.match(this.racism3)?.[0],
            },
            {
                name: 'racism5',
                check: () => this.racism5.test(testString),
                match: () => testString.match(this.racism5)?.[0],
            },
            {
                name: 'slurs',
                check: () => this.slurs.test(testString),
                match: () => testString.match(this.slurs)?.[0],
            },
            {
                name: 'slurs2',
                check: () => this.slurs2.test(testString),
                match: () => testString.match(this.slurs2)?.[0],
            },
            {
                name: 'slurs3',
                check: () => this.slurs3.test(testString),
                match: () => testString.match(this.slurs3)?.[0],
            },
            {
                name: 'slurs4',
                check: () => this.slurs4.test(testString),
                match: () => testString.match(this.slurs4)?.[0],
            },
            {
                name: 'slurs5',
                check: () => this.slurs5.test(testString),
                match: () => testString.match(this.slurs5)?.[0],
            },
            {
                name: 'tos',
                check: () => this.tos.test(testString),
                match: () => testString.match(this.tos)?.[0],
            },
            {
                name: 'tos2',
                check: () => this.tos2.test(testString),
                match: () => testString.match(this.tos2)?.[0],
            },
            {
                name: 'tos3',
                check: () => this.tos3.test(testString),
                match: () => testString.match(this.tos3)?.[0],
            },
            // { name: 'tos4', check: () => this.tos4.test(testString) },
            {
                name: 'tos5',
                check: () => this.tos5.test(testString),
                match: () => testString.match(this.tos5)?.[0],
            },
            {
                name: 'tos6',
                check: () => this.tos6.test(testString),
                match: () => testString.match(this.tos6)?.[0],
            },
            {
                name: 'tos7',
                check: () => this.tos7.test(testString),
                match: () => testString.match(this.tos7)?.[0],
            },
        ];
