...
const liveCommand = async (client, message) => {
    ...
    if (!live.isLive) {
        ...
        client.log.logAndReply(message, `A última live ${liveTarget.toLowerCase() === message.channelName ? 'aqui' : 'de ' + liveTarget} foi há ${timeSinceLastStream} - título: ${live.lastStreamTitle}`);
        return;
    }
