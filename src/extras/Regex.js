...
class CreateRegex {
  ...
  check(mainInput, arrayInput, channelID) {
    ...
    const tests = [
      ...
      {
        name: "slurs6",
        check: () => this.slurs6.test(testString),
        match: () => testString.match(this.slurs6)?.[0],
      },
      // Portuguese racism
      {
        name: "racism6",
        check: () => this.racism6.test(testString),
        match: () => testString.match(this.racism6)?.[0],
      },
      // Portuguese threats of violence
      {
        name: "tos8",
        check: () => this.tos8.test(testString),
        match: () => testString.match(this.tos8)?.[0],
      },
      // Portuguese threats of self-harm
      {
        name: "tos9",
        check: () => this.tos9.test(testString),
        match: () => testString.match(this.tos9)?.[0],
      },
      // Portuguese sexual harassment
      {
        name: "tos10",
        check: () => this.tos10.test(testString),
        match: () => testString.match(this.tos10)?.[0],
      },
    ];
